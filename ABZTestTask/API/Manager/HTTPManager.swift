...
final class HTTPManager {
    ...
    class func get(url: UrlRequest, params: [String: Any]? = nil, paramsAsPath: Any? = nil, successHandler: SuccessHandler? = nil, failureHandler: FailureHandler? = nil) {
        
        var requestUrl = url.fullUrl
        
        if let params = params {
            requestUrl += convertDictParamsToStringUrl(params)
        } else if let paramsAsPath {
            requestUrl += "/\(paramsAsPath)"
        }
